...
| # | Task | Why | Est. Time | Status |
|---|------|-----|-----------|--------|
| M1 | **Download /zomi-dataset** | 3M+ sentences, 36K+ words, 130K+ dict | 1 hr | ✅ DONE — 207MB in `data/online/` |
| M2 | **Integrate /zolai-dictionary** | 7,861 headwords, trilingual | 2 hr | ✅ DONE — 7,841 entries in `dict__merged.jsonl` |
| M3 | **Download  Bible corpus** | Tedim-Burmese parallel verses | 1 hr | ✅ DONE (in `data/online/`) |
...
|----------|-----|---------|------|--------|
| **/zomi-dataset** | github.com//zomi-dataset | 3M+ sentences, 36K+ words, 130K+ dict | 3.6GB | Download + merge vocab |
| **/zolai-dictionary** | github.com//zolai-dictionary | 7,861 headwords, trilingual | ~5MB | Download words.json |
| **** | huggingface.co/ | Tedim-Burmese Bible parallel | ~10MB | Download corpus |
...
| **** | test..net/languages/ctd | Audio Bible, resources | Unknown |
...
7. Online Sources (validation)         → , , etc.
```

### Build Order

```
Step 1: Fetch online data (, , tongdot)
...
| Download /zomi-dataset | 2026-09-07 | — |
| Integrate  dictionary | 2026-09-07 | `42e3f2b` |
| Download TongDot + Glosbe +  | 2026-09-07 | — |
...
5. feat(bible): add online data fetcher for //tongdot
...
| Resource | URL |
|----------|-----|
| /zomi-dataset | https://github.com//zomi-dataset |
| /zolai-dictionary | https://github.com//zolai-dictionary |
...
|  | https://test..net/languages/ctd |
| Zomi Spelling Guide | https://.github.io/zomi-website/ |
...
|----------|--------|------|---------|--------|
| Bible | /bible-master | 67 JSON files | 31,102 verses | ✅ Integrated |
| Dictionary (ZO→EN) | /dictionary | 11MB | 93,931 entries | ✅ Integrated |
| Dictionary (EN→ZO) | /dictionary | 56MB | 112,220 entries | ✅ Integrated |
| Dictionary (trilingual) | /zolai-dictionary | 6.1MB | 7,861 headwords | ✅ Downloaded |
| Dictionary (merged) |  + local | 6.1MB | 7,841 entries | ✅ Built |
| Dictionary (TongDot) | /zomi-dataset | 681KB | 5,004 entries | ✅ Downloaded |
| Corpus (clean) | /zomi-dataset | 208MB | 3M+ sentences | ✅ Downloaded |
...
| Conversational |  | 1.6MB | 8,913 entries | ✅ Built |
...
|-----|----------|--------|--------|
| Audio/pronunciation | HIGH |  audio Bible | 🔲 Need to download |
| Proverbs/idioms | HIGH | Bible + worship songs | ✅ DONE — 7,736 proverbs |
| Conversational data | HIGH |  (1.6MB) | ✅ DONE — 8,913 entries |
...
| Dialect variations | MEDIUM |  articles | 🔲 Can extract now |
