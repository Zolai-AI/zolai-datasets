...
| # | Task | Why | Est. Time |
|---|------|-----|-----------|
| M1 | **Download /zomi-dataset** | 3M+ sentences, 36K+ words, 130K+ dict | 1 hr |
| M2 | **Integrate /zolai-dictionary** | 7,861 headwords, trilingual | 2 hr |
| M3 | **Download  Bible corpus** | Tedim-Burmese parallel verses | 1 hr |
...
|------|-------|--------|------------|
| Download /zomi-dataset | — | QUEUED | — |
| Download /zolai-dictionary | — | QUEUED | — |
...
| Build polysemy DB (77→200+) | — | QUEUED | M1 () |
...
| Conversational |  | 1.6MB | TBD | 🔲 Pending |
...
| Conversational data | HIGH |  (1.6MB) | 🔲 Can extract now |
