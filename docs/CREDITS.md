...
|--------|-----------|----------|---------|
| Bible JSON | [/bible-master](https://github.com//bible-master) | Tedim 1932, Tedim 2010, TDB77, Hakha 1920, Falam 1973, Paite 1971 | 31,102 verses |

### Dictionary Sources

| Source | Repository | Entries | Type |
|--------|-----------|---------|------|
| Zolai→English | [/dictionary](https://github.com//dictionary) | 93,931 | Primary ZO→EN |
| English→Zolai | [/dictionary](https://github.com//dictionary) | 112,220 | Primary EN→ZO |
| Trilingual | [/zolai-dictionary](https://github.com//zolai-dictionary) | 7,861 | ZO-EN-MY |
| TongDot | [/zomi-dataset](https://github.com//zomi-dataset) | 5,004 | ZO-EN |

### Corpus Sources

| Source | Repository | Size | Content |
|--------|-----------|------|---------|
| Clean corpus | [/zomi-dataset](https://github.com//zomi-dataset) | 208MB | 3M+ sentences |
| Worship songs | [/zomi-dataset](https://github.com//zomi-dataset) | 573KB | Lyrics |
| Conversational | [/zomi-dataset](https://github.com//zomi-dataset) | 547KB | Spoken data |
