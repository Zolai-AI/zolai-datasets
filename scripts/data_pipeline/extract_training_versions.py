...
archive = Path(str(Path(__file__).resolve().parents[3]) + "/data/archive/training_versions")
output = Path(str(Path(__file__).resolve().parents[3]) + "/data/training/master_all_versions.jsonl")
