#!/usr/bin/env python3
"""
Extract vocabulary from  corpus (3M+ lines, ~208MB).
...
CORPUS_FILES = [
    DATA_DIR / "online" / "-corpus" / "zomi_clean_p1.txt",
    DATA_DIR / "online" / "-corpus" / "zomi_clean_p2.txt",
    DATA_DIR / "online" / "-corpus" / "zomi_clean_p3.txt",
    DATA_DIR / "online" / "-corpus" / "zomi_clean_p4.txt",
]
